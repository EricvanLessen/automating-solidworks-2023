...
Module AddComponents
    ...
    Public Sub AddCompAndMate(ByVal PartPath As String)
        ...
        If Model.GetType <> swDocumentTypes_e.swDocASSEMBLY Then
            MsgBox("For use with assemblies only.",
        ...
        For Each CircEdge As Edge In Edges
            ...
            Dim MyComp As Component2 = MyAssy.AddComponent4(PartPath,
        "", Center(0), Center(1), Center(2))
          ...
          swMateAlign_e.swMateAlignALIGNED, False,
          0, 0, 0, 0, 0, 0, 0, 0, False, False, 0, errors)
            ...
            If Not MyAxis Is Nothing Then
                ...
                MyMate = MyAssy.AddMate5(swMateType_e.swMateCONCENTRIC,
          swMateAlign_e.swMateAlignCLOSEST, False,
    ...
    Private Function OpenPartInvisible(ByVal PartPath As String) As PartDoc
      ...
      (PartPath, swDocumentTypes_e.swDocPART,
    ...
    Private Function GetCircleCenter(ByVal MyCurve As Curve,
