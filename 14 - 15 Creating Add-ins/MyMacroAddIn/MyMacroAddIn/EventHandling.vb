...
Public Class PartEventHandler
    ...
    Private Function PartDoc_FileSaveAsNotify2(FileName As String) As Integer
        Dim cp As New CustomProps
        Dim propName As String = "Description"
        If cp.PropExists(iPart, propName) Then
            Return 0 'continue the save as action
        Else
            iSwApp.SendMsgToUser2("Please add a " & propName & " property before saving.",
                    swMessageBoxIcon_e.swMbStop, swMessageBoxBtn_e.swMbOk)
            Return 1 'stop the save as action
        End If
...
Public Class AssemblyEventHandler
    ...
    Private Function AssemblyDoc_FileSaveAsNotify2(FileName As String) As Integer
        Dim cp As New CustomProps
        Dim propName As String = "Description"
        If cp.PropExists(iAssembly, propName) Then
            Return 0 'continue the save as action
        Else
            iSwApp.SendMsgToUser2("Please add a " _
                & propName & " property before saving.",
                swMessageBoxIcon_e.swMbStop, swMessageBoxBtn_e.swMbOk)
            Return 1 'stop the save as action
        End If
    End Function
...
Public Class DrawingEventHandler
    ...
    Private Function DrawingDoc_FileSaveAsNotify2(FileName As String) As Integer
        Dim cp As New CustomProps
        Dim propName As String = "Description"
        If cp.PropExists(iDrawing, propName) Then
            Return 0 'continue the save as action
        Else
            iSwApp.SendMsgToUser2("Please add a " _
                & propName & " property before saving.",
