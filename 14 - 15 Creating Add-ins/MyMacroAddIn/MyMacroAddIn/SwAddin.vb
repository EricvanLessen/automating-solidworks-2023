...
<Guid("85d07736-aab9-4d12-bc09-6b10102228c2")>
<ComVisible(True)>
<SwAddin(
            Description:="MyMacroAddIn description",
            Title:="MyMacroAddIn",
            LoadAtStartup:=True
            )>
...
#Region "UI Methods"
    ...
    Sub AddComponent()
        AddComponentsMod.m_swApp = iSwApp
        Dim partPath As String
        partPath = "C:\Parts\washer.sldprt" 'make sure this is a valid part path
        AddComponentsMod.AddCompAndMate(partPath)
    End Sub
    Public Sub AddCommandMgr()
        ...
        Dim Title As String = "MyMacroAddIn"
        Dim ToolTip As String = "MyMacroAddIn"
        ...
        cmdIndex1 = cmdGroup.AddCommandItem2("Add Component PMP", -1, "Add a part and mate", "Add Component PMP", 2, "ShowPMP", "PMPEnable", mainItemID2, menuToolbarOption)
